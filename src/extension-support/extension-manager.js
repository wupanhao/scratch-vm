...
const defaultBuiltinExtensions = {
    ...
    lepiChat: () => require('../extensions/lepi_chat'),
    lepiLLMImage: () => require('../extensions/lepi_llm_image'),
    lepiLLMVideo: () => require('../extensions/lepi_llm_video'),
    ...
    lepiWebSerial: () => require('../extensions/lepi_web_serial'),
    lepiLedSimulator: () => require('../extensions/lepi_led_simulator/index2'),
