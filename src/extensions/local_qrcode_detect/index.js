...
class LocalQRCodeDetection extends EventEmitter {
    constructor(runtime) {
        super();
        ...
        this.canvas.id = 'local_qrcode_detection';
    ...
    getInfo() {
        return {
            ...
            menus: {
                ...
                barCodeData: Menu.formatMenu(['文本内容', '中心点x坐标', '中心点y坐标', '宽度', '高度']),
            },
        };
    }
...
module.exports = LocalQRCodeDetection;