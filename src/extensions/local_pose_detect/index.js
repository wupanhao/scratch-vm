...
class LocalPoseDetection extends EventEmitter {
    constructor(runtime) {
        super();
        ...
        this.canvas.id = 'local_pose_detection';
    ...
    detectedPose() {
        return this.poseDetections && this.poseDetections.length >= 1
    }
...
module.exports = LocalPoseDetection;