...
class WS extends JSONRPC {

    /**
     * A WS peripheral socket object.  It handles connecting, over web sockets, to
     * WS peripherals, and reading and writing data to them.
    ...
    constructor(runtime, extensionId, peripheralOptions, connectCallback, resetCallback = null, messageCallback) {
        ...
        this._socket = runtime.getScratchLinkSocket('WS');
    ...
    sendMessage(options) {
        console.log('WS::sendMessage', options)
        /*
    ...
    handleDisconnectError( /* e */) {
        // log.error(`WS error: ${JSON.stringify(e)}`);
        return;
    ...
    _handleRequestError(e) {
        ...
        console.log('PERIPHERAL_REQUEST_ERROR', e)
        return
